...
error_reporting(0);
  ...
  if (!empty($_REQUEST['w']))
	switch ($_REQUEST['w'])
	{
		...
		case 'lbg': case 'hbg' : $title="Light Bowgun / Heavy Bowgun"; $fname="LBTrans.csv"; $weapname='Light Bowgun'; $altweapname='Heavy Bowgun';break;
		case 'sa': $title="Switch Axe"; $fname="SATrans.csv"; break;

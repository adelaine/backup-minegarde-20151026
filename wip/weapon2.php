...
error_reporting(0);
  ...
  if (!empty($_REQUEST['w']))
	switch ($_REQUEST['w'])
	{
	  case 'gs': case 'ls': $title="Great Swords / Long Swords"; $fname="GSTrans_2.csv"; $weapname='Great Swords'; $altweapname='Long Swords'; break;
	  case 'sns': case 'ds': $title="Sword and Shield / Dual Swords"; $fname="SnSTrans_2.csv"; $weapname='Sword and Shield'; $altweapname='Dual Swords'; break;
	  case 'hm': case 'hh': $title="Hammers / Hunting Horns"; $fname="HMTrans_2.csv"; $weapname='Hammers'; $altweapname='Hunting Horns'; break;
	  case 'lc': case 'gl': $title="Lances / Gunlances"; $fname="LCTrans_2.csv"; $weapname='Lances'; $altweapname='Gunlances'; break;
		case 'bw': $title="Bows"; $fname="BWTrans_2.csv"; $weapname="Bows"; $altweapname=""; break;
	  case 'lbg': case 'hbg' : $title="Light Bowgun / Heavy Bowgun"; $fname="LBTrans_2.csv"; $weapname='Light Bowgun'; $altweapname='Heavy Bowgun';break;
		default : $title="Great Swords / Long Swords"; $fname="GSTrans_2.csv"; $weapname='Great Swords'; $altweapname='Long Swords'; break;
	}
  else
  {
	$title="Great Swords / Long Swords"; $fname="GSTrans_2.csv";
...
//added by Zack here remove later
else
{
